    ...
    <center>
      ...
      <fieldset>
        <legend>ESP32 Firmware Update</legend>
          <div id="spacer_20"></div>
          <form method="POST" action="%MGR_BASE_PATH%/update" enctype="multipart/form-data">
      ...
      <fieldset>
        <legend>File upload</legend>
          <div id="spacer_20"></div>
          <form method="POST" action="%MGR_BASE_PATH%/upload" enctype="multipart/form-data">
            <table><tr><td id="first_td_th">
      ...
      <fieldset>
        <legend>Delete file</legend>
          <div id="spacer_20"></div>
          <form method="GET" action="%MGR_BASE_PATH%/delete">
            <table><tr><td id="first_td_th">          
            %DELETE_FILES%
            </td><td>
      ...
      <fieldset>
        <legend>Format SPIFFS</legend>
          <div id="spacer_20"></div>
          <form method="POST" action="%MGR_BASE_PATH%/format" target="self_page">
            <table><tr><td id="first_td_th">
